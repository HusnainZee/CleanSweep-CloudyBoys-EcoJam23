...
public class PaperDetection : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "Paper")
        {
            ...
            Anim.SetBool("PaperWrong", false);
            Anim.SetBool("PaperCorrect", true);

            StartCoroutine(Wait());
        }
        else if (collision.tag == "Metal" || collision.tag == "Plastic" || collision.tag == "Organic" || collision.tag == "Glass")
        {
            Destroy(collision.gameObject);
            ...
            Anim.SetBool("PaperCorrect", false);
            Anim.SetBool("PaperWrong", true);
