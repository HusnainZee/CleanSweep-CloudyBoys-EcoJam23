...
public class OrganicDetection : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "Organic")
        {
            ...
            Anim.SetBool("OrganicWrong", false);
            Anim.SetBool("OrganicCorrect", true);

            StartCoroutine(Wait());
        }
        else if (collision.tag == "Metal" || collision.tag == "Plastic" || collision.tag == "Glass" || collision.tag == "Paper")
        {
            Destroy(collision.gameObject);
            ...
            Anim.SetBool("OrganicCorrect", false);
            Anim.SetBool("OrganicWrong", true);
