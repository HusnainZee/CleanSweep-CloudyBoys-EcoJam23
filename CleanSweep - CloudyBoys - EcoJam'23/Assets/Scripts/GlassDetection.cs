...
public class GlassDetection : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "Glass")
        {
            ...
            Anim.SetBool("GlassWrong", false);
            Anim.SetBool("GlassCorrect", true);

            StartCoroutine(Wait());
        }
        else if (collision.tag == "Metal" || collision.tag == "Plastic" || collision.tag == "Organic" || collision.tag == "Paper")
        {
            Destroy(collision.gameObject);
            ...
            Anim.SetBool("GlassCorrect", false);
            Anim.SetBool("GlassWrong", true);
